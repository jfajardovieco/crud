...
const FormUser = ({ createUser, infoUpdate, updateUsers, setInfoUpdate, isDisable, setIsDisable}) => {
...
useEffect( () =>{
  ...
  return (
    <div className={`form_container ${isDisable && 'form__disable'}`}>
        ...
        <label className="form__label">
          <span className="form__span">Birsthday: </span>
